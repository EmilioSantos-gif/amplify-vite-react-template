  ...
  return (
    ...
    >
      ...
      <TextField
        ...
        onChange={handleFieldChange}
        onBlur={() => runValidationTasks("ubicacionTerreno", formData.ubicacionTerreno)}
      ...
      <TextField
        ...
        onChange={handleFieldChange}
        onBlur={() => runValidationTasks("direccionInmueble", formData.direccionInmueble)}
      ...
      <TextField
        ...
        onChange={handleFieldChange}
        onBlur={() => runValidationTasks("constanciaVenta", formData.constanciaVenta)}
      ...
      <TextField
        ...
        onChange={handleFieldChange}
        onBlur={() => runValidationTasks("designacionCatastral", formData.designacionCatastral)}
      ...
      <TextField
        ...
        onChange={handleFieldChange}
        onBlur={() => runValidationTasks("manzanaLegal", formData.manzanaLegal)}
      ...
      <TextField
        ...
        onChange={handleFieldChange}
        onBlur={() => runValidationTasks("tipologiaVecindario", formData.tipologiaVecindario)}
