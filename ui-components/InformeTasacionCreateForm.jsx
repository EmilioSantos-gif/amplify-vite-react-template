...
export default function InformeTasacionCreateForm(props) {
  ...
  const resetStateValues = () => {
    setFechaTasacion(initialValues.fechaTasacion);
    setServiceDesk(initialValues.serviceDesk);
    setTipoTasacion(initialValues.tipoTasacion);
    setPisos(initialValues.pisos);
    setTipo(initialValues.tipo);
    setEntidadBancaria(initialValues.entidadBancaria);
    setTipoTopologia(initialValues.tipoTopologia);
    setUbicacion(initialValues.ubicacion);
    setUbicacionTerreno(initialValues.ubicacionTerreno);
    setPropietario(initialValues.propietario);
    setNombreSolicitante(initialValues.nombreSolicitante);
    setApellidoSolicitante(initialValues.apellidoSolicitante);
    setCondominio(initialValues.condominio);
    setDireccionInmueble(initialValues.direccionInmueble);
    setBloque(initialValues.bloque);
    setEtapa(initialValues.etapa);
    setManzana(initialValues.manzana);
    setEdificioNo(initialValues.edificioNo);
    setTipoEdificio(initialValues.tipoEdificio);
    setNumeroTitulo(initialValues.numeroTitulo);
    setConstanciaVenta(initialValues.constanciaVenta);
    setDesignacionCatastral(initialValues.designacionCatastral);
    setLibroNo(initialValues.libroNo);
    setFolioNo(initialValues.folioNo);
    setParcela(initialValues.parcela);
    setSolar(initialValues.solar);
    setManzanaLegal(initialValues.manzanaLegal);
    setDc(initialValues.dc);
    setLocalidad(initialValues.localidad);
    setDesarrollo(initialValues.desarrollo);
    setTipologiaVecindario(initialValues.tipologiaVecindario);
    setClaseSocial(initialValues.claseSocial);
    setAceras(initialValues.aceras);
    setContenes(initialValues.contenes);
    setCallesAsfaltadas(initialValues.callesAsfaltadas);
    setAlcantarillado(initialValues.alcantarillado);
    setAguaPotable(initialValues.aguaPotable);
    setAlumbradoElectrico(initialValues.alumbradoElectrico);
    setTelecomunicaciones(initialValues.telecomunicaciones);
    setTransportePublico(initialValues.transportePublico);
    setOtrosInfraestructura(initialValues.otrosInfraestructura);
    setArea(initialValues.area);
    setForma(initialValues.forma);
    setTopografia(initialValues.topografia);
    setEdad(initialValues.edad);
    setNivelEdificacion(initialValues.nivelEdificacion);
    setDescripcionInterior(initialValues.descripcionInterior);
    setTerminacionPisosInteriores(initialValues.terminacionPisosInteriores);
    setTerminacionPisosExteriores(initialValues.terminacionPisosExteriores);
    setTerminacionHuellas(initialValues.terminacionHuellas);
    setTerminacionMuros(initialValues.terminacionMuros);
    setTerminacionRevestimiento(initialValues.terminacionRevestimiento);
    setTerminacionPuertaPrincipal(initialValues.terminacionPuertaPrincipal);
    setTerminacionPuertasInteriores(initialValues.terminacionPuertasInteriores);
    setTerminacionPuertasCloset(initialValues.terminacionPuertasCloset);
    setTerminacionGabinetes(initialValues.terminacionGabinetes);
    setTerminacionTopeCocina(initialValues.terminacionTopeCocina);
    setTerminacionTecho(initialValues.terminacionTecho);
    setTerminacionCornisa(initialValues.terminacionCornisa);
    setTerminacionPlafones(initialValues.terminacionPlafones);
    setTerminacionVentanas(initialValues.terminacionVentanas);
    setTerminacionPasamanos(initialValues.terminacionPasamanos);
    setAreaBasicoTerreno(initialValues.areaBasicoTerreno);
    setCostoMetroBasicoTerreno(initialValues.costoMetroBasicoTerreno);
    setAreaBasicoConstruccion(initialValues.areaBasicoConstruccion);
    setCostoMetroBasicoConstruccion(initialValues.costoMetroBasicoConstruccion);
    setMontoDepreciacion(initialValues.montoDepreciacion);
    setMontoMejoras(initialValues.montoMejoras);
    setDepreciacionMejoras(initialValues.depreciacionMejoras);
    setValorInmueble(initialValues.valorInmueble);
  ...
  return (
    ...
    >
      ...
      <Heading
        level={4}>
          Características del Terreno y Mejoras
      </Heading>
      <Heading
        level={5}>
          Terreno
